...
const App: React.FC = () => {
  ...
  const finalizeSession = async () => {
    ...
    // Note: ZIP download removed - sessions are saved to backend only
    // Users can access recordings through the archives view
    setProductionStep("Session Saved to Archives");
  };
